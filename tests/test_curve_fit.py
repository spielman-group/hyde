...
def make_plugin_host(plugin_manager):
    app = build_plugin_host(plugin_manager)
    # Curve fit reaches its own figure and table plugins through the event bus,
    # so this host dispatches for real rather than recording.
