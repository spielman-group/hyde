...
if __name__ == '__main__':
    ...
    # Install Hyde's signal marker before connecting to the ProcessTree.
    # zprocess KillLock intentionally remains the active SIGTERM handler after
    # connection; installing Hyde first lets KillLock wrap Hyde's marker instead
    # of Hyde replacing KillLock's active handler.
    import hyde
    hyde.gui_mode(True)
